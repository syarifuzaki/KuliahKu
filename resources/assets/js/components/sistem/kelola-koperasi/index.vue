            ...
            <div class="col-xs-12">
                ...
                <div class="card">
                    <ol class="breadcrumb breadcrumb-col-indigo">
                        ...
                        <li class="active"><i class="material-icons">store</i> Usaha Ku</li>
                    </ol>
                </div>
                <!-- Konten utama -->
                <div class="card">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">{{ modalTitle }} Usaha Ku</h4>
                    </div>
                    <form class="form-horizontal add" @submit.prevent="formAction(state.id)">
                        <div v-if="modalTitle == 'Tambah'">
                            <div class="modal-body">
                                ...
                                <div class="row clearfix">
                                    <div class="col-xs-4 form-control-label">
                                        <label for="name">Nama Usaha Ku *</label>
                                    </div>
                                    <div class="col-xs-8">
                                        <div class="form-group">
                                            <div class="form-line">
    ...
    data () {
        return {
            api: {
                ...
                users: 'api/sistem/user/getIDForKoperasi'
            },
            color: 'bg-indigo',
            rows: {
                total: -1
