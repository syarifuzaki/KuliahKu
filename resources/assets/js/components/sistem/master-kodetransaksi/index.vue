            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">{{ modalTitle }} Kode Transaksi</h4>
                    </div>
                    <form class="form-horizontal add" @submit.prevent="formAction(state.id)">
                        ...
                        <div v-if="modalTitle == 'Hapus'">
                            <div class="modal-body">
                                Apakah anda yakin ingin menghapus kode transaksi <b>{{ state.name }}</b> ini?
                            </div>
                            <div class="modal-footer">
...
export default {
    data () {
        return {
            api: {
                index: 'api/sistem/kode',
                lastid: 'api/sistem/kode/getLastID'
            },
            color: 'bg-indigo',
            rows: {
                total: -1
