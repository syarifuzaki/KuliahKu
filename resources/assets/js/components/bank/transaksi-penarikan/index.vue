            ...
            <div class="col-xs-12">
                ...
                <div class="card">
                    <ol class="breadcrumb breadcrumb-col-green">
                        ...
                        <li><a><i class="material-icons">swap_horiz</i> Transaksi Koperasi Ku</a></li>
                        <li class="active"><i class="material-icons">trending_down</i> Penarikan Tunai</li>
                    </ol>
                </div>
                <!-- Konten utama -->
                <div class="card">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">{{ modalTitle }} Transaksi Koperasi Ku</h4>
                    </div>
