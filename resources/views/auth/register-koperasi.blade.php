    ...
    <div class="row">
        <div class="col-md-12">
            <header class="content-title">
                <h1 class="title">Daftar Usaha Ku</h1>
            ...
            <form id="register-form" method="POST" action="{{ route('register.koperasi') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <fieldset>
                            <h2 class="sub-title">Profil Usaha Ku</h2>
                            {{-- ID Koperasi--}}
                            ...
                            <div class="input-group{{ $errors->has('koperasi_name') ? ' has-error' : '' }}">
                                ...
                                <input type="text" id="koperasi_name" name="koperasi_name" value="{{ old('koperasi_name') }}" class="form-control input-lg" placeholder="Nama usaha anda" required>
                            </div>
                            ...
                            <div class="input-group{{ $errors->has('koperasi_address') ? ' has-error' : '' }}">
                                <span class="input-group-addon"><span class="input-icon input-icon-address"></span><span class="input-text">Alamat</span></span>
                                <input type="text" id="koperasi_address" name="koperasi_address" value="{{ old('koperasi_address') }}" class="form-control input-lg" placeholder="Alamat usaha anda">
                            </div>
                            ...
                            <div class="input-group textarea-container">
                                <span class="input-group-addon"><span class="input-icon input-icon-message"></span><span class="input-text">Penjelasan singkat tentang usaha anda</span></span>
