...
INSERT INTO `banks` (`id`, `user_id`, `name`, `address`, `description`, `order_number`, `active`, `created_at`, `updated_at`) VALUES
	('BANK000001', 'bank', 'Bank Kuliah-Ku', NULL, NULL, 1, 1, '2018-12-01 05:49:34', '2018-12-01 05:49:34');
...
INSERT INTO `codes` (`id`, `name`, `description`, `type`, `active`) VALUES
	(1, 'Debit', 'menabung uang ke koperasi', '+', 1),
	(2, 'Kredit', 'menarik tunai dari koperasi', '-', 1),
	(3, 'Belanja', 'berbelanja di Usaha Ku', '-', 1);
...
INSERT INTO `customers` (`id`, `user_id`, `bank_id`, `family_member`, `active`, `created_at`, `updated_at`) VALUES
	(1, 'nasabah', 'BANK000001', 1234567890, 1, '2018-12-01 06:43:29', '2018-12-01 06:43:29'),
	(2, 'nasabah2', 'BANK000001', 1987654321, 1, '2018-12-01 10:45:44', '2018-12-01 10:45:44');
...
INSERT INTO `goods` (`id`, `koperasi_id`, `category_id`, `name`, `description`, `priority`, `price`, `picture`, `active`, `created_at`, `updated_at`) VALUES
	(1, 'KOPR000001', 1, 'Kentang', NULL, 'standard', 5000.00, '', 1, '2018-12-01 06:20:23', '2018-12-01 06:20:23'),
	(2, 'KOPR000001', 2, 'Teh Sisri', NULL, 'high', 500.00, '', 1, '2018-12-01 10:01:31', '2018-12-01 10:01:31'),
	(3, 'KOPR000001', 3, 'Pensil', NULL, 'standard', 2500.00, '', 1, '2018-12-01 10:39:53', '2018-12-01 10:39:53');
...
INSERT INTO `koperasis` (`id`, `user_id`, `name`, `address`, `description`, `order_number`, `active`, `created_at`, `updated_at`) VALUES
	('KOPR000001', 'usahaku', 'Usaha Sukses', NULL, NULL, 1, 1, '2018-12-01 05:49:21', '2018-12-01 05:49:21');
...
INSERT INTO `receipts` (`id`, `koperasi_id`, `customer_id`, `status`, `created_at`, `updated_at`) VALUES
	(3, 'KOPR000001', 1, 'processed', '2018-12-01 08:39:36', '2018-12-01 09:00:45'),
	(4, 'KOPR000001', 1, 'verified', '2018-12-01 10:43:02', '2018-12-01 10:43:43');
...
INSERT INTO `roles` (`id`, `name`, `display_name`, `description`, `created_at`, `updated_at`) VALUES
	(1, 'admin_sistem', 'Admin Sistem', 'mengelola sistem informasi secara keseluruhan (developer)', '2018-12-01 05:46:32', '2018-12-01 05:46:32'),
	(2, 'admin_koperasi', 'Usaha Ku', 'mengelola barang dan transaksi belanja yang ada di sistem informasi', '2018-12-01 05:46:32', '2018-12-01 05:46:32'),
	(3, 'admin_bank', 'Koperasi Ku', 'mengelola nasabah dan transaksi-transaksi perbankan yang ada di sistem informasi', '2018-12-01 05:46:32', '2018-12-01 05:46:32'),
	(4, 'nasabah', 'Nasabah', 'melakukan transaksi belanja dan perbankan di sistem informasi', '2018-12-01 05:46:32', '2018-12-01 05:46:32');
...
INSERT INTO `stocks` (`id`, `good_id`, `user_id`, `value`, `created_at`, `updated_at`) VALUES
	(1, 1, 'usahaku', 10, '2018-12-01 06:29:54', '2018-12-01 06:29:54'),
	(2, 3, 'usahaku', 10, '2018-12-01 10:42:25', '2018-12-01 10:42:25'),
	(5, 3, 'nasabah', -1, '2018-12-01 10:43:02', '2018-12-01 10:43:02');
...
INSERT INTO `transactions` (`id`, `code_id`, `customer_id`, `value`, `created_at`, `updated_at`) VALUES
	(1, 3, 1, -5000.00, '2018-12-01 07:12:07', '2018-12-01 07:12:07'),
	(2, 1, 1, 10000.00, '2018-12-01 08:05:05', '2018-12-01 08:05:05'),
	(3, 3, 1, -5000.00, '2018-12-01 08:06:47', '2018-12-01 08:06:47'),
	(4, 1, 1, 10000.00, '2018-12-01 08:39:07', '2018-12-01 08:39:07'),
	(5, 3, 1, -5000.00, '2018-12-01 08:39:36', '2018-12-01 08:39:36'),
	(6, 1, 1, 5000.00, '2018-12-01 10:41:28', '2018-12-01 10:41:28'),
	(7, 3, 1, -2500.00, '2018-12-01 10:43:02', '2018-12-01 10:43:02');
...
INSERT INTO `users` (`id`, `email`, `name`, `address`, `phone_number`, `gender`, `birth_date`, `password`, `active`, `remember_token`, `created_at`, `updated_at`) VALUES
	('adminsistem', 'kuliahku@gmail.com', 'Admin Kuliah-Ku', 'Surakarta', '', 'male', '1996-09-11', '$2y$10$2Zlbx.mVnaX5z9avi.HcXuEObp47AkLa59hohPh4a7zoXMazkHLwi', 1, 'TjHDUFdfb5xxv3OPEEJOQGa8RO5dSJbK4eMHf3514zWqvhiftotqNBqQbOLx', '2018-12-01 05:46:32', '2018-12-01 05:46:32'),
	('bank', 'bank@gmail.com', 'Admin Koperasi-Ku', NULL, '', NULL, NULL, '$2y$10$Hr8/GOV0OhS/6kNnT0YkHO4uGKALZnIVExuGQ1hoUMl/OB9gb6CWe', 1, '7oNfiJHTPlNYR417M61PgrNZFu5wr5KPKq5r4hugqhnNwXItWxbZx7zoXnbF', '2018-12-01 05:49:09', '2018-12-01 05:49:09'),
	('usahaku', 'usahaku@gmail.com', 'Admin Usaha-Ku', NULL, '', NULL, NULL, '$2y$10$Q8kumHi3WMw6tmP0mFakT.y/PA/RSMMwrHWn6xn5XVuWarZvJpj7C', 1, 'u7JfXjwsOKdI0rNIuXqlgDMw7EEP2XbVwDQXVJLbL8YiKVutEfUA7KM1DF8Y', '2018-12-01 05:48:14', '2018-12-01 05:48:14'),
	('nasabah', 'nasabah@gmail.com', 'Nasabah', NULL, '', NULL, NULL, '$2y$10$wXmPINUX6SkPWX.PG0WMIO7jGnWcH8UPU81vGmGq16hf9FraEM5/i', 1, 'umxDRqesvPLY357AdUlVMqKFwydTamUeQmIfrMQXCY79Ij24DrygWbBd1oYh', '2018-12-01 06:43:29', '2018-12-01 06:43:29'),
	('nasabah2', 'nasabah2@gmail.com', 'Nasabah2', NULL, '', NULL, NULL, '$2y$10$fblboIjPJX00eYatjDa//.CMk8xau/rmvRtaeRrOVAXeoQ1TsoGbi', 1, 'Dqytx6WrVGm7EP3G1IqVAFzJlxbQz6jFBTXfwm451qRu9bq5bQ1dmyRFjcfa', '2018-12-01 10:45:44', '2018-12-01 10:45:44');
